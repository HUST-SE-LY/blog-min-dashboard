...
import { deleteSingleBlog, getBlogList, getBlogTags, updateBlogInfo } from "../utils/requests";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div onClick={() => deleteBlog()} className="relative min-h-[2rem] w-full text-center cursor-pointer border-[1px] border-red-300 transition-all hover:text-white hover:bg-red-500 text-sm leading-[2rem] px-[1rem] overflow-hidden rounded-2xl ">
          删除博客
        </div>
      </div>
    </div>
